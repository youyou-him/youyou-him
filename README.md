# AI Agent & Data-Driven AI Engineer
...
## 1. AURA  
멀티 에이전트 기반 매거진 자동 생성 시스템

- LangGraph 기반 Agent Graph 설계
...
## 2. TRAVEL AI  
비정형 데이터 정형화 및 RAG 기반 B2B 상담 지원 시스템

- Excel/PDF/이미지 데이터 정형화 파이프라인 구현
- Retrieval → Re-ranking → Generation 구조 설계
...
## 3. CUBE AI  
고객 이탈 예측 및 CLTV 분석 프로젝트

- BG/NBD + Gamma-Gamma 기반 CLTV 모델링
- GBM 기반 이탈 예측 모델 구축
...
## 4. CARGO AI  
LGBMRanker 기반 추천 시스템 프로젝트

- 추천 모델 학습 및 랭킹 로직 구현
- 공정성 피처 반영 리랭킹 설계
- Flask 기반 API 서버 구축

🔗 https://github.com/youyou-him/cargo_ai

---

## 5. Sleep Health Coach  
수면 데이터 기반 예측 및 군집 분석

- SMOTE 기반 클래스 불균형 완화
- LightGBM/RF 비교 실험
- K-Means 기반 사용자 유형 분류

🔗 https://github.com/youyou-him/sleep

---

# Engineering Background

## Flutter & Dart Full-Stack Development (4년, 독학)
