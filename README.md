...
* **삼성 아카데미 (Samsung Academy)** | **[ ✏️ 과정명, 예: AI/데이터 분석 과정 ]**
  ...
  * **딥러닝 (CNN):** `TensorFlow`, `Keras`를 활용한 딥러닝 기초, CNN 모델 구축 (MNIST, 이미지 분류 실습)
